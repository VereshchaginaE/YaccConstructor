...
while cur < small_gotos.Length do
    ...
    cur <- cur + length
let private lists_reduces = [|[|0,1|]; [|0,2|]; [|0,3|]; [|2,1|]; [|4,1|]; [|6,1|]|]
...
while cur < small_reduces.Length do
    ...
    cur <- cur + length
let private lists_zeroReduces = [|[|7|]; [|7; 1; 0|]; [|5|]; [|3|]|]
...
let _rnglr_epsilons : Tree<Token>[] = [|new Tree<_>(null,box (new AST(new Family(8, new Nodes([||])), null)), null); new Tree<_>(null,box (new AST(new Family(0, new Nodes([|box (new AST(new Family(7, new Nodes([||])), null)); box (new AST(new Family(5, new Nodes([||])), null)); box (new AST(new Family(3, new Nodes([||])), null))|])), null)), null); new Tree<_>(null,box (new AST(new Family(7, new Nodes([||])), null)), null); new Tree<_>(null,box (new AST(new Family(5, new Nodes([||])), null)), null); new Tree<_>(null,box (new AST(new Family(3, new Nodes([||])), null)), null); new Tree<_>(null,box (new AST(new Family(1, new Nodes([|box (new AST(new Family(0, new Nodes([|box (new AST(new Family(7, new Nodes([||])), null)); box (new AST(new Family(5, new Nodes([||])), null)); box (new AST(new Family(3, new Nodes([||])), null))|])), null))|])), null)), null)|]
