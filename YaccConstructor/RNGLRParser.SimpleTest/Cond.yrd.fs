...
while cur < small_gotos.Length do
    ...
    cur <- cur + length
let private lists_reduces = [|[|0,1|]; [|2,1|]; [|8,1|]; [|4,4|]; [|7,1|]; [|6,1; 2,1|]; [|5,1|]; [|3,2|]; [|5,1; 3,2|]|]
...
let _rnglr_epsilons : Tree<Token>[] = [|new Tree<_>(null,box (new AST(new Family(9, new Nodes([||])), null)), null); null; null; null; null; null; null|]
let _rnglr_filtered_epsilons : Tree<Token>[] = [|new Tree<_>(null,box (new AST(new Family(9, new Nodes([||])), null)), null); null; null; null; null; null; null|]
