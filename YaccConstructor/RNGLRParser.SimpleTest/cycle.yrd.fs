...
let private small_gotos =
        [|3; 65536; 131073; 262146; 65537; 327683|]
...
let _rnglr_epsilons : Tree<Token>[] = [|new Tree<_>(null,box (new AST(new Family(4, new Nodes([||])), null)), null); null; null; null|]
let _rnglr_filtered_epsilons : Tree<Token>[] = [|new Tree<_>(null,box (new AST(new Family(4, new Nodes([||])), null)), null); null; null; null|]
for x in _rnglr_filtered_epsilons do if x <> null then x.ChooseSingleAst()
let _rnglr_extra_array, _rnglr_rule_, _rnglr_concats = 
  (Array.zeroCreate 0 : array<'_rnglr_type_error * '_rnglr_type_s * '_rnglr_type_start * '_rnglr_type_yard_start_rule>), 
  [|
  (
